module.exports = {
  ...
  PATH: {
    DATABASES_DDB_TABLES_DIR: `${process.cwd()}/src/databases/dynamodb/tables`,
    DATABASES_PG_MIGRATIONS_DIR: `${process.cwd()}/src/databases/postgres/migrations`,
    DATABASES_PG_MIGRATIONS_LAMBDA: `${__dirname}/../assets/lambdas/postgres-migrations/index.js`,
    DATABASES_PG_MIGRATIONS_LAMBDA_MIGRATIONS_DIR: 'migrations',
