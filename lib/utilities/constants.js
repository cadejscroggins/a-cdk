...
module.exports = {
  ...
  PATH: {
    A_CDK_NODE_MODULES_DIR: path.join(__dirname, '../..', 'node_modules'),
    DATABASES_DDB_TABLES_DIR: path.join(CWD, 'src/databases/dynamodb/tables'),
    ...
    LAMBDAS_DIR: path.join(CWD, '/src/lambdas'),
    RESOLVERS_DIR: path.join(CWD, '/src/graphql/resolvers'),
    RESOLVER_FUNCTIONS_DIR: path.join(CWD, '/src/graphql/resolvers/functions'),
    SCHEMA_DEFINITION_FILE: path.join(CWD, '/src/graphql/schema.graphql'),
  },
  TABLE_NAME: {
